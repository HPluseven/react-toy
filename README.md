...
| 规范 | commitlint + husky                 | ✅       | [v1](https://github.com/HPluseven/react-toy/tree/v1) |q
...
执行`pnpm demo`会运行项目`demos`目录下的示例项目（默认项目是针对[v7](https://github.com/HPluseven/react-toy/tree/v7)的调试项目）
