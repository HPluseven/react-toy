...
| 测试 | jest 环境搭建                      | ✅       | [v4](https://github.com/HPluseven/react-toy/tree/v4) |
| 规范 | tsc                                | ✅       | [v1](https://github.com/HPluseven/react-toy/tree/v1) |
...
| ReactDOM   | 浏览器环境 DOM 的移动                  | ✅       | [v7](https://github.com/HPluseven/react-toy/tree/v7)   |
...
| ReactNoop  | ReactNoop Renderer                     | ✅       | [v10](https://github.com/HPluseven/react-toy/tree/v10) |
...
| Reconciler | Lane 模型                              | ✅       | [v8](https://github.com/HPluseven/react-toy/tree/v8)   |
| Reconciler | 基础 Update 机制                       | ✅       | [v1](https://github.com/HPluseven/react-toy/tree/v1)   |
| Reconciler | 带优先级的 Update 机制                 | ✅       | [v8](https://github.com/HPluseven/react-toy/tree/v8)   |
| Reconciler | 插入单节点的 mount 流程                | ✅       | [v1](https://github.com/HPluseven/react-toy/tree/v1)   |
| Reconciler | 插入多节点的 mount 流程                | ✅       | [v7](https://github.com/HPluseven/react-toy/tree/v7)   |
| Reconciler | 插入单节点的 reconcile 流程            | ✅       | [v5](https://github.com/HPluseven/react-toy/tree/v5)   |
| Reconciler | 插入多节点的 reconcile 流程            | ✅       | [v7](https://github.com/HPluseven/react-toy/tree/v7)   |
...
| Reconciler | useEffect 实现                         | ✅       | [v9](https://github.com/HPluseven/react-toy/tree/v9)   |
| Reconciler | useRef 实现                            | ⬜️      |                                                     |
| Reconciler | Legacy 调度流程（包含 batchedUpdates） | ✅       | [v8](https://github.com/HPluseven/react-toy/tree/v8)   |
| Reconciler | Concurrent 调度流程                    | ✅       | [v11](https://github.com/HPluseven/react-toy/tree/v11) |
| Reconciler | 异常处理流程                           | ⬜️      |                                                     |
...
执行`pnpm demo`会运行项目`demos`目录下的示例项目（默认项目是针对[v9](https://github.com/HPluseven/react-toy/tree/v9)的调试项目）
...
### [v11](https://github.com/HPluseven/react-toy/tree/v11)
...
### [v10](https://github.com/HPluseven/react-toy/tree/v10)
...
### [v9](https://github.com/HPluseven/react-toy/tree/v9)
...
### [v8](https://github.com/HPluseven/react-toy/tree/v8)
...
### [v7](https://github.com/HPluseven/react-toy/tree/v7)
...
### [v3](https://github.com/HPluseven/react-toy/tree/v3)
